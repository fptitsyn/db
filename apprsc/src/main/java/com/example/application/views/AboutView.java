...
public class AboutView extends VerticalLayout {
    ...
    public AboutView() {
        ...
        add(new H5("08.04"));
        add(new Span("Добавлена Entity Schedule"));
        add(new Span("Создан Защита от дубликатов в расписание - уникальный индекс"));
        add(new Span("Создана роцедура для создания расписания для сотрудник в конкретном офисе на день(с проверкой существующих записей)."));
